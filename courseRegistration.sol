...
contract CourseRegistration is Ownable {
    ...
    constructor(address _identityNFTAddress, address _feePaymentAddress) Ownable(msg.sender) {
    ...
    function registerCourse(uint256 courseId) public {
        ...
        require(identityNFT.identityTokenByOwner(msg.sender) != 0, "No valid Identity NFT found");
